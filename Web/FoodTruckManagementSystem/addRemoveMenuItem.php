...
try{
	...
	if (isset($_POST['addMenuItem'])) {
		$c->creatMenuItem($itemName, $itemPrice);
	...
	elseif (isset($_POST['removeMenuItem'])){
		...
		$_SESSION["successItem"] = "Successfully remove ".$itemtName." item from Menu List!";
	}
	elseif (isset($_POST['menuItemOrder'])){
		$c->menuItemOrder($itemName, $itemQuantityOrder);
		$_SESSION["successItem"] = "Successfully order ".$itemName." item(s)!";
	}
	$_SESSION["errorItem"] = "";
